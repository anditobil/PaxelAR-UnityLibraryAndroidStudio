package com.blicodes.arpaxelapp
 ...
 * Use the [UnityARPaxelFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class UnityARPaxelFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_unity_ar_paxel, container, false)
        frameLayoutForUnity =
